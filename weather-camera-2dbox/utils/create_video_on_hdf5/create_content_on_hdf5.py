...
def create_video_sample(hdf5_file, show_depth=True):
    with h5py.File(hdf5_file, 'r') as file:
        ...
        out = cv2.VideoWriter('{}/output.mp4'.format(Path(hdf5_file).parent), cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), 20, (frame_width, frame_height))
...
if __name__ == "__main__":
    ...
    create_video_sample(
        "/home/hyun/DATA/Codes/carla_hyunkoo_examples/carla-dataset-runner/data/hdf5_file.hdf5",
        show_depth=False)
